...
export class FileDiv extends StorageDiv implements FileDiv_I {
    ...
    constructor(fileNode: FileNode_EXC_I, fileSystemService: IFileSystemService) {
    ...
    private setupEventListeners(): void {
        ...
        this.addEventListener("click", (e) => {
            ...
            if (e.target instanceof HTMLDivElement && e.target.contentEditable == "false") {
                this.fileSystemService.openFileInEditor(this.fileNode); // Assuming TabCreator is a class responsible
    ...
    public openFile() {
        this.fileSystemService.openFileInEditor(this.fileNode)
    }
