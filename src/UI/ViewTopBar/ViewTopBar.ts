...
//        let tabCreator = this.tabManager.getTabCreator();
        ...
        saveFile.addEventListener('click', function (e) {
            ...
            console.log("save file clicked"); // Log the click event
        });
        ...
        saveAllFile.addEventListener('click', function (e) {
            uiEventService.trigger(APPUIEvent.saveAll, {}); // Trigger the event when the button is clicked
//@todo            that.fileManager.saveAllFile();
            console.log("save all file clicked"); // Log the click event
        });
...
//@todo            that.fileManager.closeApplication();
        ...
        settingApplication.addEventListener('click', function (e) {
            uiEventService.trigger(APPUIEvent.openSetting); // Trigger the event to open the file with the app 
        ...
        infoApplication.addEventListener('click', function (e) {
            console.log("InfoApplication clicked"); // Log the click event
            uiEventService.trigger(APPUIEvent.openInfo ,"../../src/Applications/InfoPage/index.html"); // Trigger the event to open the file with the app 
